<template>
  <base-nav
    class="main-nav flex-row align-items-md-center navbar-horizontal"
    type=""
    effect="light"
    expand
  >
    ...
    <ul class="navbar-nav flex-row mr-auto ml-4 d-none d-md-flex">
      ...
      <li class="nav-item">
        <a
          class="nav-link"
          href="https://vue-argon-dashboard-laravel.creative-tim.com"
          target="_blank"
          >Live Preview</a
        >
      </li>
      <li class="nav-item">
        <a
          class="nav-link"
          href="https://github.com/creativetimofficial/vue-argon-dashboard-laravel/issues"
          target="_blank"
          >Support</a
        >
      </li>
    ...
    <div class="d-none d-sm-block ml-auto">
      <ul class="navbar-nav ct-navbar-nav flex-row align-items-center">
        <li class="nav-item dropdown d-none">
          <a
            class="btn-link text-white dropdown-toggle mr-sm-3"
            href="#"
            id="ct-versions"
          ...
          <div class="dropdown-menu" aria-labelledby="ct-versions">
            <a class="dropdown-item active" href="../../docs/1.0/"
              >Latest - 1.0</a
            >
          </div>
        </li>
